...
Various egg beater photographs and sketches.

<div className="row border">
    <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724207311/FullSizeRender_-_Copy_14_um1on5.jpg"
         alt="Egg Beater Ink Sketch" className="solo-image"/>
    <div className="column">
        <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724207289/FullSizeRender_2_k5edxr.jpg"
             alt="Egg Beater Photo" className="image"/>
        <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724207259/IMG_7084_lfhfmk.jpg"
             alt="Egg Beater Photo"
             className="image"/>
        <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724214679/FullSizeRender_4_k9qecl.jpg"
             alt="Egg Beater Photo" className="image"/>
    </div>
    <div className="column">
        <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724214649/IMG_7082_hmzqcr.jpg"
             alt="Egg Beater Photo" className="image"/>
        <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724214665/IMG_7089_ranasu.jpg"
             alt="Egg Beater Photo"
             className="image"/>
        <img src="https://res.cloudinary.com/dadbbieca/image/upload/v1724207282/IMG_7083_pnc8dg.jpg"
             alt="Egg Beater Photo"
             className="image"/>
    </div>
</div>
...
<div className="image-grid border">
    <img src="/images/folder/image1.jpg" alt="Image 1" class="image"/>
    <img src="/images/folder/image2.jpg" alt="Image 2" class="image"/>
    <img src="/images/folder/image3.jpg" alt="Image 3" class="image"/>
</div>
