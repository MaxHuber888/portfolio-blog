...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">
        This is my portfolio, containing all of the projects that I am proud of.
        This list includes both purely personal projects and work done for
        school or competitions. Projects in each category are listed in
        chronological order.
      </p>
      <p className="mb-4">
        Even if a project is marked as [CLOSED] that does not mean I won't
        eventually come back to it, it just means I am not currently focused on
        adding to it.
      </p>
      <div className="mb-4 border">
        <h2
          className="font-semibold text-xl mb-4 tracking-tighter"
          style={{ color: "#00A99D" }}
        >
          ML/AI:
        </h2>
